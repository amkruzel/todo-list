...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _classes_taskList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/taskList */ "./src/classes/taskList.js");
...
/* harmony import */ var _classes_PageProperties__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/PageProperties */ "./src/classes/PageProperties.js");
...
const buildClasses = () => {
  const Page        = new _classes_PageProperties__WEBPACK_IMPORTED_MODULE_2__["default"]()
  const taskList    = new _classes_taskList__WEBPACK_IMPORTED_MODULE_0__["default"]()
  const projectList = new _classes_projectList__WEBPACK_IMPORTED_MODULE_1__["default"]()

  return { Page, taskList, projectList }
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (buildClasses);
...
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
/* harmony import */ var _buildClasses__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./buildClasses */ "./src/buildClasses.js");
...
const { header, newTaskBtn, newProjectBtn, clearStorageBtn }  = (0,_buildHeader__WEBPACK_IMPORTED_MODULE_2__["default"])()
...
if (localStorage.getItem('projectList')) {
  ...
  pl.all.forEach(function(p) {
    projectList.add(new _classes_project__WEBPACK_IMPORTED_MODULE_8__["default"]( {
      name: p.name,
      desc: p.desc,
      color: p.color,
      id: p.id
...
if (localStorage.getItem('taskList')) {
  ...
  tl.all.forEach(function(t) {
    taskList.add(new _classes_task__WEBPACK_IMPORTED_MODULE_6__["default"]( { 
      name: t.name,
      desc: t.desc,
