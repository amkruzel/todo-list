...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildProjectFormModal": () => (/* binding */ buildProjectFormModal),
/* harmony export */   "buildTaskFormModal": () => (/* binding */ buildTaskFormModal),
/* harmony export */   "closeAndClearForm": () => (/* binding */ closeAndClearForm),
...
const buildMain = () => {
  ...
  const pracDate = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('div')
...
class Project {
  constructor(obj) { //color in hex format
    ...
    this.icon        = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_1__.newProjectIcon)(color)
...
const projectForm = (0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.buildProjectFormModal)()
...
header.addEventListener('click', function(e) {
  if (e.target === newTaskBtn) {
    if (!Page.isTaskFormOpen) {
      ...
      ;(0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.showForm)(taskForm, projectList)
    } else {
  ...
  if (e.target === newProjectBtn) {
    if (!Page.isProjectFormOpen) {
      ...
      ;(0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.showForm)(projectForm)
    } else {
...
taskForm.closeBtn.addEventListener('click', function() {
  ;(0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.closeAndClearForm)(taskForm)
  Page.isTaskFormOpen = false
})

projectForm.closeBtn.addEventListener('click', function() {
  ;(0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.closeAndClearForm)(projectForm)
...
taskForm.submitBtn.addEventListener('click', function() {
  ...
  ;(0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__.refreshTasks)(main, taskList)
})
