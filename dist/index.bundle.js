...
const DOMmethods = () => {
  ...
  const showForm = (form, projList = []) => {
    ...
    if (form.context === 'project') {
      form.color.value = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.randomColor)()
    }
  ...
  const _createTask = (t, projects) => {
    ...
    const task = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('div')
  ...
  const _createProject = (p) => {
    const projLi = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('li', 'extra-chevron')
    const projLiSpan = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('div')
  ...
  const _createProjectTask = (task, p) => {
    const taskLi = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('li')
    const taskLiSpan = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('div')
...
const { header, newTaskBtn, newProjectBtn }  = (0,_buildHeader__WEBPACK_IMPORTED_MODULE_2__["default"])()
const { sidebar, ulProjects } = (0,_buildSidebar__WEBPACK_IMPORTED_MODULE_3__["default"])()
const { main, mainFilter }    = (0,_buildMain__WEBPACK_IMPORTED_MODULE_4__["default"])()


const DOM         = (0,_DOMmethods__WEBPACK_IMPORTED_MODULE_5__["default"])()
...
taskForm.submitBtn.addEventListener('click', function() {
  ...
  let newTask = new _classes_task__WEBPACK_IMPORTED_MODULE_6__["default"](results)
...
projectForm.submitBtn.addEventListener('click', function() {
  ...
  projectList.add(new _classes_project__WEBPACK_IMPORTED_MODULE_8__["default"](results))
