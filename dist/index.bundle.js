...
sidebar.addEventListener('click', function(e) {
  ...
  if (f === 'upcoming') {
    taskList.addFilter('dateRange', [
      new Date(),
      (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_11__["default"])(new Date(), 7)
    ])
  }
