...
/* harmony import */ var date_fns_isEqual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns/isEqual */ "./node_modules/date-fns/esm/isEqual/index.js");
// TaskList class 
  ...
  */
  ...
  #filterOneTask(task) {
    ...
    for (const [key, value] of Object.entries(this.curFilter)) {
      ...
      if (key === 'dateRange') {
        if (
          (0,date_fns_isEqual__WEBPACK_IMPORTED_MODULE_0__["default"])(value[0], task.dueDate) || 
          (0,date_fns_isEqual__WEBPACK_IMPORTED_MODULE_0__["default"])(value[1], task.dueDate)
        ) { return true }
        if (
