...
const DOMmethods = () => {
  ...
  const _createTask = (t, projects) => {
    ...
    if (!t.isComplete) {
      task.textContent     = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.unstrikeThrough)(task.textContent)
      taskDate.textContent = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.unstrikeThrough)(taskDate.textContent)
...
/* harmony export */   "unstrikeThrough": () => (/* binding */ unstrikeThrough)
/* harmony export */ });
