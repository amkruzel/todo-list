...
const DOMmethods = () => {
  ...
  const buildTaskDetailsModal = () => {
    ...
    // Buttons
    const editTaskBtn   = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('button')
    const formCloseBtn  = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.newElement)('span', 'close')
    formCloseBtn.textContent = '\u2715'
...
const { header, newTaskBtn, newProjectBtn, clearStorageBtn }  = (0,_buildHeader__WEBPACK_IMPORTED_MODULE_1__["default"])()
const { sidebar, ulProjects } = (0,_buildSidebar__WEBPACK_IMPORTED_MODULE_2__["default"])()
const { main, mainFilter }    = (0,_buildMain__WEBPACK_IMPORTED_MODULE_3__["default"])()
...
;(0,_localStorage__WEBPACK_IMPORTED_MODULE_5__["default"])(taskList, projectList)
